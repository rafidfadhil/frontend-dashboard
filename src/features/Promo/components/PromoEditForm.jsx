...
const PromoEditForm = ({dataPromo, isFetching, isPending, handleSubmit, handleChange, handleChangeTanggalAwal, handleChangeTanggalAkhir, handleChangeJam}) => {
    const navigate = useNavigate()
    const {nama, kode, diskon, tanggal_awal, tanggal_akhir, jam_awal, jam_akhir} = dataPromo

  return (
    <SectionTitle title='Edit Promo'>
        ...
        <form onSubmit={handleSubmit} className='grid grid-cols-1 auto-cols-min gap-5'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <label className="form-control w-full">
                        ...
                        <input type='number' name='diskon' value={diskon} onChange={handleChange} placeholder='Total Diskon' className="input input-bordered text-lg w-full" />
                </label>
                <div className="form-control w-full">
                        <div className="label">
