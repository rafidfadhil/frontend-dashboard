...
const MembershipFormView = ({currentState, isFetching, isPending, handleSubmit}) => {
  ...
  return (
    <SectionTitle title='Detail Membership'>
        ...
        <form className='grid grid-cols-1 auto-cols-min gap-5'>
            <CardInput title='Paket Membership' >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <label className="form-control w-full">
                        ...
                        <select className="select select-bordered text-lg font-medium capitalize" name='paket' onChange={(e) => handleChangePaket(e, 'data_member')} value={paket} disabled>
                    ...
                    <label className="form-control w-full">
                        ...
                        <select className="select select-bordered text-lg font-medium capitalize" name='jenis_keanggotaan' onChange={(e) => handleChangeKeanggotaan(e, 'data_member')} value={jenis_keanggotaan} disabled>
            ...
            <CardInput title='Data Diri' >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <label className="form-control w-full">
                        ...
                        <input type='text' name='no_ktp' value={no_ktp} onChange={(e) => handleChange(e, 'data_member')} placeholder='No KTP' className="input input-bordered text-lg w-full" required readOnly />
                    </label>
                    <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Nama lengkap*</span>
                        </div>
                        <input type='text' name='nama_lengkap' value={nama_lengkap} onChange={(e) => handleChange(e, 'data_member')} placeholder='Nama Lengkap' className="input input-bordered text-lg w-full" required readOnly />
                    </label>
                    <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Jenis Kelamin</span>
                        </div>
                        <select className="select select-bordered text-lg font-medium capitalize" name='jenis_kelamin' onChange={(e) => handleChange(e, 'data_member')} value={jenis_kelamin} disabled>
                    ...
                    <label className="form-control w-full">
                        ...
                        <input type='text' name='kota' value={kota} onChange={(e) => handleChange(e, 'data_member')} placeholder='Kota' className="input input-bordered text-lg w-full" required readOnly />
                    </label>
                    <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Alamat</span>
                        </div>
                        <input type='text' name='alamat_rumah' value={alamat_rumah} onChange={(e) => handleChange(e, 'data_member')} placeholder='Alamat Rumah' className="input input-bordered text-lg w-full" required readOnly />
                    </label>
                </div>
            </CardInput>
            <CardInput title='Informasi Kontak' >
                <label className="form-control w-full">
                        ...
                        <input type='text' name='no_wa' value={no_wa} onChange={(e) => handleChange(e, 'data_member')} placeholder='No Whatsapp' className="input input-bordered text-lg w-full" required readOnly />
                </label> 
                <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Email*</span>
                        </div>
                        <input type='text' name='email' value={email} onChange={(e) => handleChange(e, 'data_member')} placeholder='Email' className="input input-bordered text-lg w-full" required readOnly />
                </label>
            </CardInput>
            <CardInput title='Data Usaha' >
                <label className="form-control w-full">
                        ...
                        <input type='text' name='nama_perusahaan' value={nama_perusahaan} onChange={(e) => handleChange(e, 'usaha_anda')} placeholder='Nama Perusahaan' className="input input-bordered text-lg w-full" readOnly />
                </label> 
                <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Bidang Usaha</span>
                        </div>
                        <input type='text' name='bidang_usaha' value={bidang_usaha} onChange={(e) => handleChange(e, 'usaha_anda')} placeholder='Bidang Usaha' className="input input-bordered text-lg w-full" readOnly />
                </label> 
                <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Jabatan</span>
                        </div>
                        <input type='text' name='jabatan' value={jabatan} onChange={(e) => handleChange(e, 'usaha_anda')} placeholder='Jabatan' className="input input-bordered text-lg w-full" readOnly />
                </label> 
                <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Alamat Kantor</span>
                        </div>
                        <input type='text' name='alamat_kantor' value={alamat_kantor} onChange={(e) => handleChange(e, 'usaha_anda')} placeholder='Alamat Kantor' className="input input-bordered text-lg w-full" readOnly />
                </label> 
                <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Telepon</span>
                        </div>
                        <input type='tel' name='telp' value={telp} onChange={(e) => handleChange(e, 'usaha_anda')} placeholder='Telepon' className="input input-bordered text-lg w-full" readOnly />
                </label> 
                <label className="form-control w-full">
                        <div className="label">
                            <span className="label-text text-lg font-medium">Kartu Kredit</span>
                        </div>
                        <select className="select select-bordered text-lg font-medium capitalize" name='kartu_kredit' onChange={(e) => handleChange(e, 'usaha_anda')} value={kartu_kredit} disabled>
                ...
                <label className="form-control w-full">
                        ...
                        <input type='text' name='no_kartu_kredit' value={no_kartu_kredit} onChange={(e) => handleChange(e, 'usaha_anda')} placeholder='Nomor Kartu Kredit' className="input input-bordered text-lg w-full" readOnly />
                </label> 
            </CardInput>
            <CardInput title='Dokumen Persyaratan' >
                <label className="form-control w-full">
                    ...
                    <input type="file" accept=".png,.jpg,.jpeg,.pdf" name={'ktp_passport'} onChange={handleChangeFile} className="file-input file-input-bordered border-borderGreen w-full" required={currentState !== 'update'} disabled />
                ...
                <label className="form-control w-full">
                    ...
                    <input type="file" accept=".png,.jpg,.jpeg,.pdf" name={'pas_photo'} onChange={handleChangeFile} className="file-input file-input-bordered border-borderGreen w-full" required={currentState !== 'update'} disabled />
                ...
                <label className="form-control w-full">
                    ...
                    <input type="file" accept=".png,.jpg,.jpeg,.pdf" name={'kartu_keluarga'} onChange={handleChangeFile} className="file-input file-input-bordered border-borderGreen w-full" required={currentState !== 'update'} disabled />
            ...
            <CardInput title='Anggota Tambahan' >
                <label className="form-control w-full">
                    ...
                    <div className='flex flex-col gap-4'>
                            ...
                            {anggota_membership.map((item, i) => {
                                return (
                                    <div className='flex items-center gap-4'>
                                        ...
                                        <input key={i} className={`grow input input-bordered text-fontGrey font-medium px-4 rounded-[4px]`} type='text' placeholder='Masukkan anggota tambahan' id="nama" name='nama' value={item} onChange={(e) => handleChangeAnggota(e, i)} readOnly />                 
                        ...
                        <ButtonPrimary disabled type="button" onClick={() => dispatch(setTambahAnggotaMembership())}>
